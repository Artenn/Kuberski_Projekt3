        ...
        while(true) {
            ...
            if (opcja == 1) {
                ...
                for(Covid c: CovidRepository.getCovidList()){
                    ...
                    lista.add("\"death-ratio\" : "+covidRepository.deathratio(c));
                    lista.add("\"recover-ratio\" : "+covidRepository.recoverratio(c));
                    lista.add("\"covid-ratio\" : "+covidRepository.covidratio(c)+"}");
